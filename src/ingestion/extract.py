...
def extract_latest_session_data():
    ...
    if drivers_data:
        ...
        telemetry_data = fetch_endpoint(
            "car_data",
            {"session_key": session_key, "driver_number": driver_number, "limit": 5000},
        )
        ...
        if telemetry_data:
            ...
            print(
                f"No telemetry data found for driver {driver_name} in session {session_key}"
            )
